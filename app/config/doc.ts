...
- branches: The branches that will be added to the version switcher. If none, left as empty array. If running locally, "local" will be added by the code.
- releaseBranch: the branch used as a release branch
